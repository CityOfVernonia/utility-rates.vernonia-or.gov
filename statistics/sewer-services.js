...
(function (document, appMain, Chart, ChartDataLabels) {
  ...
  appMain.getServicesData({
    where: `WSC_TYPE = 'BILLABLE' AND SEWER = 1`,
    ...
    .then(results => {
      ...
      new Chart(document.querySelector('canvas[data-chart-sewer-services]').getContext('2d'), {
        type: 'bar',
        data: {
          labels,
          datasets: [{
      ...
      document.querySelector('*[data-sewer-services-count]').innerHTML = total;

      new Chart(document.querySelector('canvas[data-chart-sewer-multipliers]').getContext('2d'), {
        type: 'bar',
        data: {
          labels,
          datasets: [{
      ...
      document.querySelector('*[data-sewer-multipliers-count]').innerHTML = (
      ...
      new Chart(document.querySelector('canvas[data-chart-sewer-city]').getContext('2d'), {
        type: 'doughnut',
        plugins: [ChartDataLabels],
        options: {
          legend: {
  ...
  appMain.getServicesData({
    ...
    .then(results => {
      ...
      new Chart(document.querySelector('canvas[data-chart-sewer-service-types]').getContext('2d'), {
        type: 'bar',
        data: {
